...
// Workers predecessor, whose migrations were applied out-of-band by
// wrangler against a directory on disk.
//
...
// to know whether a database is up to date (the readiness probe) compare it
// against goose_db_version: probing for a specific table would only ever
